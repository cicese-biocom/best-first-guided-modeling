...
public class ClassificationModelInfo {
    ...
    public ClassificationModelInfo(int size, int modelId, double accLoo, double seLoo, double spLoo, double mccLoo, double accExt, double seExt, double spExt, double mccExt) {
        this.size = size;
    ...
    public ClassificationModelInfo(AbstractClassifier clas, String[] desc, int size, long modelId, double accLoo, double seLoo, double spLoo, double mccLoo,
                                   double accExt, double seExt, double spExt, double mccExt) throws AExOpDCSException {
        try{
            clas = (AbstractClassifier) AbstractClassifier.makeCopy(clas);
        } catch (Exception e) {
            throw AExOpDCSException.ExceptionType.CLASSIFIER_LOAD_EXCEPTION.get("Error coping the classifier", e);
        }
        setDesc(desc);
        this.size = size;
        this.modelId = modelId;
    ...
    public ClassificationModelInfo(AbstractClassifier clas, String[] desc, String selName, String claName, int size,
                                   long modelId, double accLoo, double seLoo, double spLoo, double mccLoo, double accExt,
                                   double seExt, double spExt, double mccExt) throws AExOpDCSException {
        try{
            clas = (AbstractClassifier) AbstractClassifier.makeCopy(clas);
        } catch (Exception e) {
            throw AExOpDCSException.ExceptionType.CLASSIFIER_LOAD_EXCEPTION.get("Error coping the classifier",e);
