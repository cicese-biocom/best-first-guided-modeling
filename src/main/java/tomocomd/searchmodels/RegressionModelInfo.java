...
public class RegressionModelInfo {
    ...
    public RegressionModelInfo(AbstractClassifier c, long modelId, int size, double r2Loo, double maeLoo, double rmseLoo,
                               double r2Ext, double maeExt, double rmseExt,  String[] descN) throws AExOpDCSException {
    ...
    public RegressionModelInfo(AbstractClassifier c, long modelId, int size, double r2Loo, double maeLoo, double rmseLoo,
                               double r2Ext, double maeExt, double rmseExt, String[] descN, String s, String cN) throws AExOpDCSException {
        try{
            clas = (AbstractClassifier) AbstractClassifier.makeCopy(c);
        } catch (Exception e) {
            throw AExOpDCSException.ExceptionType.CLASSIFIER_LOAD_EXCEPTION.get("Error coping the classifier",e);
    ...
    public RegressionModelInfo(int modelId, int size, double r2Loo, double maeLoo, double rmseLoo, double r2Ext,
                               double maeExt, double rmseExt) {
        this.modelId = modelId;
        this.r2Loo = roundAvoid(r2Loo);
        this.maeLoo = roundAvoid(maeLoo);
        this.r2Ext = roundAvoid(r2Ext);
